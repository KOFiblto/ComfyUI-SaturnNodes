...
app.registerExtension({
    ...
    async setup() {
        ...
        const renderTitleColor = renderSketchColorSetting("SaturnNodes.🖼️ Visual Loaders.00_CustomNodeHeaderColor", "#c85a2c");
        app.ui.settings.addSetting({
            ...
            defaultValue: getInitialSetting("SaturnNodes.🖼️ Visual Loaders.00_CustomNodeHeaderColor", "#c85a2c"),
        ...
        const renderBgColor = renderSketchColorSetting("SaturnNodes.🖼️ Visual Loaders.00_CustomNodeBgColor", "#210f09");
        app.ui.settings.addSetting({
            id: "SaturnNodes.🖼️ Visual Loaders.00_CustomNodeBgColor",
            name: "Custom Node Body Color",
            type: renderBgColor,
            render: renderBgColor,
            defaultValue: getInitialSetting("SaturnNodes.🖼️ Visual Loaders.00_CustomNodeBgColor", "#210f09"),
